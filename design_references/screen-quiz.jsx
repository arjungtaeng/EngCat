...
function ECScreenQuiz() {
  ...
  return (
    <div style={{ height: '100dvh', background: T.bg1, position: 'relative', display: 'flex', flexDirection: 'column' }}>
      <ECStatusBar />
        ...
        {choices.map(c => {
          ...
          return (
            <div key={c.id} onClick={() => !answered && setSelected(c.id)} style={{
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontFamily: T.serif, fontSize: 16, color: T.text, fontStyle: 'italic' }}>{c.en}</div>
