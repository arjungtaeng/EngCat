      ...
      <div style={{ padding: '0 20px' }}>
        <div style={{ borderRadius: 18, overflow: 'hidden', position: 'relative' }}>
          ...
          <div style={{
            ...
            fontFamily: T.thin, fontWeight: 200, fontStyle: 'italic', fontSize: 13.5, color: T.text,
          }}>
        ...
        {choices.map(c => {
          ...
          return (
            <div key={c.id} onClick={() => !answered && setSelected(c.id)} style={{
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontFamily: T.display, fontWeight: 400, fontSize: 16, color: T.text }}>{c.en}</div>
