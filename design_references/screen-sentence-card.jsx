    ...
    <div style={{ flex: 1, minHeight: 0, background: T.bg1, display: 'flex', flexDirection: 'column' }}>
      <div style={{ flex: 1, position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        ...
        >
          ...
          <div style={{ padding: '14px 18px 0' }}>
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ flex: 1, fontFamily: T.display, fontSize: 15, fontStyle: 'italic', color: T.bg0, lineHeight: 1.25 }}>
          ...
          <div style={{ padding: '20px 22px 0' }}>
            <div style={{
              fontFamily: T.display, fontSize: 26, fontStyle: 'italic', lineHeight: 1.2, color: T.text,
              letterSpacing: -0.3,
            }}>
              "{renderSentence(s.en, s.highlight)}"
            </div>
