...
// 5-card scrollable study deck. Navigation via button only — no swipe-to-next.
...
function ECScreenSentenceCard() {
  ...
  return (
    <div style={{ flex: 1, minHeight: 0, background: T.bg1, display: 'flex', flexDirection: 'column' }}>
      ...
      {/* ── Fixed top bar ── */}
      <div style={{ flexShrink: 0, background: T.bg1 }}>
        <ECStatusBar/>
      ...
      <div
        ...
        style={{ flex: 1, overflowY: 'auto', WebkitOverflowScrolling: 'touch', paddingBottom: 24 }}
      >
        {/* Situation tag */}
        ...
        <div style={{ padding: '20px 22px 0' }}>
          <div style={{
            fontFamily: T.serif, fontSize: 24, lineHeight: 1.3, color: T.text,
            fontStyle: 'italic', letterSpacing: -0.3,
          }}>
            "{renderSentence(s.en, s.highlight)}"
          </div>
          <div style={{ marginTop: 8, fontSize: 14, color: T.textDim, lineHeight: 1.5 }}>
            {s.ko}
          </div>
        ...
        {/* Progress rail (inline, below buttons) */}
